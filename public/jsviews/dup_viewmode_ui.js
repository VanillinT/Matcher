...
;(function(){
  ...
  if ('number' == typeof $$obj.length) {
      for (var j = 0, $$l = $$obj.length; j < $$l; j++) {
        var file = $$obj[j];
pug_html = pug_html + "\u003Ctable" + (" class=\"table table-hover table-borderless table-sm m-0\""+pug_attr("id", 'row_' + i + j, true, false)) + "\u003E\u003Ctbody class=\"d-inline\"\u003E\u003Ctr\u003E\u003Cth class=\"d-inline-block\"\u003E\u003Cimg class=\"icon\" src=\"open-iconic\u002Fsvg\u002Ffile.svg\"\u002F\u003E\u003C\u002Fth\u003E\u003Cth class=\"d-inline-block\"\u003E\u003Clabel class=\"m-auto\"\u003E" + (pug_escape(null == (pug_interp = file.name) ? "" : pug_interp)) + "\u003C\u002Flabel\u003E\u003C\u002Fth\u003E\u003Cth" + (" class=\"d-none\""+pug_attr("id", 'controls_for_row_' + i + j, true, false)) + "\u003E\u003Cdiv class=\"d-inline-block\"\u003E\u003Cbutton" + (" class=\"btn btn-sm p-0 border-0\""+pug_attr("onclick", 'viewFile("' + file.path + '",' + '"row_' + i + j + '")', true, false)) + "\u003E\u003Cimg class=\"icon\" src=\"open-iconic\u002Fsvg\u002Feye.svg\"\u002F\u003E\u003C\u002Fbutton\u003E\u003Cbutton" + (" class=\"btn btn-sm p-0 border-0 mx-1\""+pug_attr("onclick", 'downloadFile("' + file.name + '","' + file.root +'")', true, false)) + "\u003E\u003Cimg class=\"icon\" src=\"open-iconic\u002Fsvg\u002Fdata-transfer-download.svg\"\u002F\u003E\u003C\u002Fbutton\u003E\u003Cbutton" + (" class=\"btn btn-sm p-0 border-0\""+pug_attr("onclick", 'deleteFile("' + file.fullpath + '",' + '"row_' + i + j + '")', true, false)) + "\u003E\u003Cimg class=\"icon\" src=\"open-iconic\u002Fsvg\u002Ftrash.svg\"\u002F\u003E\u003C\u002Fbutton\u003E\u003C\u002Fdiv\u003E\u003C\u002Fth\u003E\u003C\u002Ftr\u003E\u003C\u002Ftbody\u003E\u003C\u002Ftable\u003E";
      }
  } else {
    var $$l = 0;
    for (var j in $$obj) {
